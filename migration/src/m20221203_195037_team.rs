        ...
        manager
            .create_table(
                Table::create()
                    ...
                    // Team role
                    .col(ColumnDef::new(Team::FKTeamRoleId).big_integer())
                    .foreign_key(
                        ForeignKey::create()
                            .name("team_role_fk")
                    ...
                    // Team category
                    .col(ColumnDef::new(Team::FKTeamCategoryId).big_integer().null())
                    .foreign_key(
                        ForeignKey::create()
                    ...
                    .col(
                        ColumnDef::new(Team::FKGeneralChannelId)
                            .big_integer()
                            .null(),
                    )
                    .foreign_key(
                    ...
                    // Team trade channel
                    .col(ColumnDef::new(Team::FKTradeChannelId).big_integer().null())
                    .foreign_key(
                        ForeignKey::create()
                    ...
                    // Team menu channel
                    .col(ColumnDef::new(Team::FKMenuChannelId).big_integer().null())
                    .foreign_key(
                        ForeignKey::create()
