...
use serenity::{all::ResolvedOption, builder::CreateCommand, model::prelude::GuildId, prelude::Context};
...
pub trait GameCommand {
    ...
    async fn run(options: &[ResolvedOption], guild_id: GuildId, db: DBWrapper, ctx: Context) -> String;
}
